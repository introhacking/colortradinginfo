...
const FromURLTable = () => {
    ...
    //     // const value1 = parseFloat(row[key]) || 0;
    //     // const value2 = parseFloat(prevData[key]) || 0;
    //     const value1 = row[key] || 0;
    //     const value2 = prevData[index]?.[key] || 0;
    //     console.log(value1)
    //     // console.log('=============================================')
    //     // console.log(value2)
    //     // diffRow[key] = value1 - value2;
                ...
                <div className='flex justify-between gap-2 items-center'>
                    <div className='flex justify-start'>
                        ...
                        <div className="flex ml-3">
                            <Button
                                className={`px-4 py-2 text-sm font-semibold ${activeTab === 'latest' ? 'bg-blue-600 text-white' : 'bg-gray-300'
                                    } rounded-l`}
                                onClick={() => switchTab('latest')}
                                children={'Latest Data'}
                            />
                            <Button
                                className={`px-4 py-2 text-sm font-semibold ${activeTab === 'diff' ? 'bg-blue-600 text-white' : 'bg-gray-300'
                                    } rounded-r`}
